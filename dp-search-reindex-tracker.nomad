job "dp-search-reindex-tracker" {
  ...
  group "web" {
    ...
    task "dp-search-reindex-tracker-web" {
      driver = "docker"
      ...
      vault {
        policies = ["dp-search-reindex-tracker-web"]
      }
    }
  }
  ...
  group "publishing" {
    ...
    task "dp-search-reindex-tracker-publishing" {
      driver = "docker"
      ...
      vault {
        policies = ["dp-search-reindex-tracker-publishing"]
      }
    }
  }
}